...
Summary: Get vm information from  libvirtd api for blackbird
Name: %{name}
Version: %{version}
...
* Project Page: https://github.com/Vagrants/blackbird-libvirtd
...
cp -p libvirtd.cfg $RPM_BUILD_ROOT/%{blackbird_conf_dir}/libvirtd.cfg
...
%changelog
* Wed Jul 2 2014 makochi <makocchi@gmail.com> - 0.1.0-1
- first package
